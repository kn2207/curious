...
-- use a CREATE STAGE command to create a in the “public” schema of test_ingestion database.
...
--list the files of the newly created stage
ls @test_stage;
...
--load the data using the data from S3 using the newly created stage
COPY INTO truck FROM @test_stage;
