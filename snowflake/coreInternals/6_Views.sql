...
CREATE OR REPLACE VIEW tasty_bytes.harmonized.brand_names 
    AS
...
select distinct truck_brand_name from tasty_bytes.harmonized.brand_names;
...
CREATE OR REPLACE VIEW truck_franchise
AS
SELECT
    t.*,
    f.first_name AS franchisee_first_name,
